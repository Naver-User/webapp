...
//			res.setContentType("text/html; charset=utf8");
			...
			//      우리가 생각할 때에는, 파일명에 다국어문자가 들어있든/안들어있든
			//      지정한대로 잘 브라우저가 다운로드 할 것이라 생각하지만,
			//      사실 제대로 작동안한다라는 것은, 실습을 통해서 알게 되었습니다.
			//      그럼, 어떻게 원본파일명을 넣어줘야 하는가???인데요.
			//      해답은, ASCII(정식명칭: ISO-8859-1) 문자집합으로 변환해서
			//      파일명을 헤더에 넣어줘야 합니다. (UTF8 -> ASCII/ISO-8859-1)
			String originalFilename = "한글.txt";
			originalFilename = 
					new String(originalFilename.getBytes("utf8"), "ISO-8859-1");
