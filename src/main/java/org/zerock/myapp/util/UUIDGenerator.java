...
public class UUIDGenerator {
    ...
    public static UUID generateType1UUID() {
    	log.trace("generateType1UUID() invoked.");
    ...
    private static long get64LeastSignificantBitsForVersion1() {
    	log.trace("get64LeastSignificantBitsForVersion1() invoked.");
    ...
    private static long get64MostSignificantBitsForVersion1() {
    	log.trace("get64MostSignificantBitsForVersion1() invoked.");
    ...
    public static UUID generateType3UUID(String namespace, String name)
    	...
    	log.trace("generateType3UUID(namespace, name) invoked.");
